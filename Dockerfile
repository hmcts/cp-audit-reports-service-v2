# Uses same Dockerfile as used in https://github.com/hmcts/service-cp-caseadmin-case-urn-mapper
...
COPY azurite/* /root/
RUN keytool -importcert -file /root/cert.pem -cacerts -noprompt -alias azurite || exit 0
